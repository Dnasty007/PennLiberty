...
const diamond2fPhotos = [
  ...
  "img-2.png",
  "img-3.png",
  ...Array.from({ length: 22 }, (_, i) => `IMG_${i + 4}.jpg`),
];
const diamond3fPhotos = [
  "cover.png",
  "img-2.png",
  "img-3.png",
  ...Array.from({ length: 6 }, (_, i) => `IMG_${i + 4}.jpg`),
  ...Array.from({ length: 20 }, (_, i) => `IMG_${i + 10}.jpg`),
  "IMG_430.jpg",
];
...
const rentals = [
  {
    ...
    image: asset("1704-w-diamond-st-2f", diamond2fPhotos[0]),
    gallery: gallery("1704-w-diamond-st-2f", diamond2fPhotos),
  ...
  },
  {
    ...
    area: "Temple University",
    image: asset("1704-w-diamond-st-3f", diamond3fPhotos[0]),
    gallery: gallery("1704-w-diamond-st-3f", diamond3fPhotos),
    propertyType: "Residential Lease",
    status: "Available",
    brokerage: "Penn Liberty Real Estate",
    applicationFee: "$50",
